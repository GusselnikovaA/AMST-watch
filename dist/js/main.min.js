...
!function(t){t.fn.downCount=function(e,i){var a=t.extend({date:null,offset:null},e);a.date||t.error("Date is not defined."),Date.parse(a.date)||t.error("Incorrect date format, it should look like this, 12/24/2012 12:00:00.");var d=this,s=function(){var e=new Date,t=e.getTime()+6e4*e.getTimezoneOffset();return new Date(t+36e5*a.offset)};var l=setInterval(function(){var e=new Date(a.date)-s();if(e<0)return clearInterval(l),void(i&&"function"==typeof i&&i());var t=36e5,n=Math.floor(e/864e5),r=Math.floor(e%864e5/t),f=Math.floor(e%t/6e4),o=Math.floor(e%6e4/1e3);n=2<=String(n).length?n:"0"+n,r=2<=String(r).length?r:"0"+r,f=2<=String(f).length?f:"0"+f,o=2<=String(o).length?o:"0"+o,d.find(".days").text(n),d.find(".hours").text(r),d.find(".minutes").text(f),d.find(".seconds").text(o),d.find(".days_ref").text("дн."),d.find(".hours_ref").text("час."),d.find(".minutes_ref").text("мин."),d.find(".seconds_ref").text("сек.")},1e3)}}(jQuery);
$(document).ready(function(){var e=$(".info-rating__button"),c=$(".feedback_dekstop"),a=$(".close");e.on("click",function(){c.addClass("feedback_active"),$(".feedback-slider_dekstop").slick("refresh")}),a.on("click",function(){c.removeClass("feedback_active")})});
$(document).ready(function(){var o=$(".hero__button"),e=$(".order_dekstop"),c=$(".close");o.on("click",function(){e.addClass("order_active")}),c.on("click",function(){e.removeClass("order_active")})});
...
$(document).ready(function(){$(".feedback-slider_dekstop").slick({slidesToShow:1,slidesToScroll:1,speed:2e3,arrows:!0,prevArrow:$(".feedback-arrows__left"),nextArrow:$(".feedback-arrows__right")}),$(".feedback-slider_mobile").slick({slidesToShow:1,slidesToScroll:1,speed:2e3,arrows:!0,prevArrow:$(".feedback-arrows__left"),nextArrow:$(".feedback-arrows__right")})});